                ...
                <td valign="top" align="center">
                    ...
                    <table width="150" cellspacing="0" cellpadding="0" border="0" id="child1" style="display: block;">
                        <tbody><tr height="20">
                            ...
                            <td><a class="menuchild" href="/article_thinkphp/index.php/Admin/Type/showlist" target="main">栏目管理</a></td></tr>
                        <tr height="20">
                            <td width="30" align="center"><img width="9" height="9" src="<?php echo ADMIN_IMG ?>menu_icon.gif"></td>
                            <td><a class="menuchild" href="#" target="main">文章管理</a></td></tr>
                        <tr height="20">
                            <td width="30" align="center"><img width="9" height="9" src="<?php echo ADMIN_IMG ?>menu_icon.gif"></td>
                            <td><a class="menuchild" href="/article_thinkphp/index.php/Admin/Admin/admin_edit" target="main">管理员管理</a></td></tr>
                        <tr height="20">
                            <td width="30" align="center"><img width="9" height="9" src="<?php echo ADMIN_IMG ?>menu_icon.gif"></td>
